        ...
        <div id="content_middle">
          ...
          <table width="100%" border="0">
            <tr align="center" valign="middle">
              ...
              <td width="33%" height="30"><form action="/Joinus/SearchNewFriendServlet" method="get">
           ...
           <c:forEach items="${ requestScope.lsts}" var="friend">
            <% if(br%3==0) out.println("<tr align='center'>");%>
              ...
              <td width="247" align="center" valign="top"><p><img src="/Joinus/upload/images/photo/${friend.uphoto}"  alt="" width="240" height="240" align="middle"/></p>
                  <form name="form1" method="post" action="/Joinus/WantFriendServlet" onSubmit="javascript:confirm('请求加好友信息已发送，请耐心等待对方回复')">
                 ...
                 <form name="form2" method="post" action="/Joinus/FindToNewsServlet">
