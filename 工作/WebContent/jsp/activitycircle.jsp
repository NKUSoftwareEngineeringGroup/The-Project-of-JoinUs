 ...
 *文件名:    activitycircle.jsp
 *作者:	   李东池
 *日期:	   20/05/2015  
 *文件描述:   活动圈页面
 *修改历史:
           日期1 20/05/2015       李东池	   创建
           日期2 23/05/2015  李东池  修改      
           日期3 26/05/2015  蒲孟  修改          --%>
<%@page import="java.util.Date"%>
<%@page import="java.text.SimpleDateFormat"%>
<%@page import="edu.newdesign.joinus.vo.ShowActInIndex"%>
<%@page import="edu.newdesign.joinus.po.Tags"%>
        ...
        <div id="content_middle">
         ...
         <form id="form4" name="form4" method="post" action="ShowInActivityCircleServlet?type=4">
          ...
          <table width="720" border="1" style="border-style:none;">
            <tr>
              <td>            
                <div><a href="/Joinus/ShowInOthersServlet?uccid=<%=act.getOwner_id()%>"><img src="/Joinus/upload/images/photo/<%=act.getUphoto()%>" width="50" height="50"  alt=""/></a><span><%=act.getUname()%>发布了：</span></div>           
         <div>
