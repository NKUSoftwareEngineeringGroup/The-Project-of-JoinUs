  ...
  <div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu">
      ...
      <li><a href="/Joinus/ShowInIndexServlet"> 首页</a></li>
        ...
        <li><a href="/Joinus/PreModifyServlet">修改资料</a></li>                               
         <li>  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;                               
         &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp; </li>   
       ...
       <div id="content_middle"> 
          ...
          int i=0;
           ...
           if(act1.getPtype()==1){%>
              <tr>
               <td><%=act1.getPdate() %></td>
               <td><div><a href="/Joinus/ShowInOthersServlet?uccid=<%=act1.getUccid() %>"></a><span><%=act1.getUname() %>参加由<%=act1.getOwner_id() %>发布的：<%=act1.getAname() %></span></div></td>
      ...
      <div id="content_top"></div>
       ...
       <table width="720" border="1" style="border:none">
            ...
            <c:if test="${act.ptype=='1'}">
               <div><a href="/Joinus/ShowInOthersServlet?uccid=${act.uccid }"><img src="/Joinus/upload/images/photo/${act.uphoto}" width="50" height="50"  alt=""/></a><span>${ act.uname}于${act.pdate }参加了由${ act.owner_id}发布的：</span></div>
            </c:if>
              <c:if test="${act.ptype=='0'}">
                <div><a href="/Joinus/ShowInOthersServlet?uccid=${act.uccid }"><img src="/Joinus/upload/images/photo/${act.uphoto}" width="50" height="50"  alt=""/></a><span>${ act.uname}于${act.pdate }发布了：</span></div>
            </c:if>
             <c:if test="${act.ptype=='2'}">
                 <div><a href="/Joinus/ShowInOthersServlet?uccid=${act.uccid }"><img src="/Joinus/upload/images/photo/${act.uphoto}" width="50" height="50"  alt=""/></a><span>${ act.uname}于${act.pdate }转发了由${ act.owner_id}发布的：</span></div>
            </c:if>
         <div>
           <table width="603" border="0" align="right">
             <tr>
               <td width="550"><a href="/Joinus/ToCommentServlet?aid=${act.aid}">活动名称：${act.aname }</a></td>
             </tr>
             <tr>
             ...
             <tr align="right">
              <td>
              <c:if test="${act.ptype=='0'}">
               <form id="participate" name="participate" method="post" action="/Joinus/CancelServlet">
              ...
              <c:if test="${act.ptype=='1'}">
               <form id="participate" name="participate" method="post" action="/Joinus/InParticipateServlet">
                 <input type="hidden" name="aid" id="aid" value="${act.aid }">
